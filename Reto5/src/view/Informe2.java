...
public class Informe2 extends JFrame{
    ...
    public void encabezado(){
        JLabel titulo = new JLabel("INFORME #2: TABLA PROYECTOS");
        panel.add(titulo);
    ...
    public void btnInforme2(){
        ...
        btnInfo2.setBackground(new Color(50,230,255));
    ...
    public void tabla(){
        Object columnas[] = new Object[]{"ID_Proyecto", "Constructora", "Numero_Habitaciones", "Ciudad"};
    ...
    public void data(){      
        ResultSet rs = informesController.informe2();  
        try {  
            while(rs.next()){
                ...
                modelo.addRow(new Object[] {idProyecto, constructora, habitaciones, ciudad} );
            }
