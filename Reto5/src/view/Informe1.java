...
public class Informe1 extends JFrame{
    ...
    public void encabezado(){
        JLabel titulo = new JLabel("INFORME #1: TABLA LIDER");
        panel.add(titulo);
    ...
    public void btnInforme1(){
        ...
        btnInfo1.setBackground(new Color(50,230,255));
    ...
    public void btnInforme2(){
        ...
        //EVENTO PARA MOSTRAR VENTANA INFORME #2
    ...
    public void tabla(){
        Object columnas[] = new Object[]{"ID_Lider", "Nombre", "Direccion", "Email"};
    ...
    public void data(){      
        ResultSet rs = informesController.informe1();  
        try {  
            while(rs.next()){
                ...
                modelo.addRow(new Object[] {IdLider, nombre, apellido, ciudad} );
            }
